...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The Gold BCR Core developers",
    r"BitPay Inc\.",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Gold BCR Core developers'
...
UPDATE_USAGE = """
Updates all the copyright headers of "The Gold BCR Core developers" which were
changed in a year more recent than is listed. For example:

// Copyright (c) <firstYear>-<lastYear> The Gold BCR Core developers

will be updated to:

// Copyright (c) <firstYear>-<lastModifiedYear> The Gold BCR Core developers

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> The Gold BCR Core developers

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> The Gold BCR Core developers
...
CPP_HEADER = '''
// Copyright (c) %s The Gold BCR Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Gold BCR Core developers'
                 % (filename))
...
INSERT_USAGE = """
Inserts a copyright header for "The Gold BCR Core developers" at the top of the
...
If the file already has a copyright for "The Gold BCR Core developers", the
script will exit.
