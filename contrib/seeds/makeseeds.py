#!/usr/bin/env python3
# Copyright (c) 2013-2019 The Gold BCR Core developers
...
def main():
    ...
    # Filter out hosts with multiple goldbcr ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple goldbcr ports' % (ip_stats(ips)), file=sys.stderr)
