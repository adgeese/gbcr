// Copyright (c) 2019 The Gold BCR Core developers
...
/* A AEAD class for ChaCha20-Poly1305@goldbcr.
 *
 ...
 *
 * The chacha20-poly1305@goldbcr combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@goldbcr cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@goldbcr are relatively fast in
