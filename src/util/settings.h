// Copyright (c) 2019-2020 The Gold BCR Core developers
...
//!       https://github.com/goldbcr/goldbcr/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored goldbcr settings. This struct combines settings from the command line
