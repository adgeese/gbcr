...
struct Params {
    ...
    int GBCRRewardMatchStep;
    /** Block height at which GBCRRewardMatch becomes active - rewards from
     * both chains, goldbcr and Gold BCR are in sync as of this height. */
    int GBCRRewardMatchHeight;
    /** Block height at which GBCRDiffAdj becomes active - difficulty adjustment
     * formula is changed so that block times are more reliable. */
    int GBCRDiffAdjHeight;
    /**
