...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/goldbcr/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/goldbcr/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/goldbcr/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/goldbcr/bips/blob/master/bip-0145.mediawiki\n",
                {
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    // We allow 2 arguments for compliance with BIP22. Argument 2 is ignored.
            RPCHelpMan{"submitblock",
                ...
                "See https://en.goldbcr.it/wiki/BIP_0022 for full specification.\n",
                {
