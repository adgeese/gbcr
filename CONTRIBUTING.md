Contributing to Gold BCR Core
============================

The Gold BCR Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/goldbcr/goldbcr/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Gold BCR Core PR Review Club](https://goldbcrcore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Gold BCR Core development happens on IRC, in the
#goldbcr-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/goldbcr-core-dev/](http://www.erisian.com.au/goldbcr-core-dev/)
and [http://gnusha.org/goldbcr-core-dev/](http://gnusha.org/goldbcr-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/goldbcr-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to goldbcr-qt
...
[Translation Process](https://github.com/goldbcr/goldbcr/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Gold BCR Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Gold BCR
Network Protocol consensus changes.

Whether a pull request is merged into Gold BCR Core rests with the project merge
...
Patches that change Gold BCR consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gold BCR consensus, it must have been
...
https://github.com/goldbcr/goldbcr/pull/16189).

Also see the [backport.py script](
https://github.com/goldbcr-core/goldbcr-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Gold BCR Core release.
