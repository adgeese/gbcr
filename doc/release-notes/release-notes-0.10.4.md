Gold BCR Core version 0.10.4 is now available from:

  <https://goldbcr.org/bin/goldbcr-core-0.10.4/>
...
- #6953 `43c2789` Split goldbcr-tx into its own package
- #6953 `dfe0d4d` Include goldbcr-tx binary on Debian/Ubuntu
