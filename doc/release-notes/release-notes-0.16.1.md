Gold BCR Core version 0.16.1 is now available from:

  <https://goldbcrcore.org/bin/goldbcr-core-0.16.1/>
...
- #12843 `df38b13` Test starting goldbcrd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure goldbcrd processes are cleaned up when tests end (sdaftuar)
