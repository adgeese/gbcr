Gold BCR Core version *0.15.2* is now available from:

  <https://goldbcrcore.org/bin/goldbcr-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in goldbcr-tx (TheBlueMatt)
