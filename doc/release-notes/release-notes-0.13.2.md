Gold BCR Core version 0.13.2 is now available from:

  <https://goldbcr.org/bin/goldbcr-core-0.13.2/>
...
- #8908 `4a974b2` Update goldbcr-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow goldbcr-tx to create v2 transactions (BTCdrak)
