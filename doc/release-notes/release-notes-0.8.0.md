Gold BCR-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/goldbcr/files/Gold BCR/goldbcr-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gold BCR
...
New/changed settings (command-line or goldbcr.conf file)
--------------------------------------------------------
