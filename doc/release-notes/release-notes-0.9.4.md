Gold BCR Core version 0.9.4 is now available from:

  https://goldbcr.org/bin/0.9.4/
...
this update is incompatible with the Gold BCR system and could lead to consensus
forks.

Gold BCR Core released binaries from https://goldbcr.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~goldbcr/+archive/ubuntu/goldbcr
- A third-party or self-compiled Gold BCR Core

upgrade to Gold BCR Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
