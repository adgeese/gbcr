Gold BCR version 0.5.4 is now available for download at:
http://sourceforge.net/projects/goldbcr/files/Gold BCR/goldbcr-0.5.4/
...
http://gitorious.org/goldbcr/goldbcrd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gold BCR-Qt notifications under Growl 1.3.
Increase required age of Gold BCR-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGold BCR properly when installing Gold BCR-Qt over it. (Windows)
