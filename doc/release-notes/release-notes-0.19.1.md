...
Gold BCR Core version 0.19.1 is now available from:

  <https://goldbcrcore.org/bin/goldbcr-core-0.19.1/>
...
From Gold BCR Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Gold BCR Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Gold BCR Core does not yet change appearance when
...
- #17488 fix "goldbcrd already running" warnings on macOS (fanquake)
