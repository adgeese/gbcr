Gold BCR version 0.7.2 is now available from:
  http://sourceforge.net/projects/goldbcr/files/Gold BCR/goldbcr-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Gold BCR-Qt to crash on Windows when exiting.
